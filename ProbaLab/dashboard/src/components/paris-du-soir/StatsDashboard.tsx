    ...
    return (
        <div className={cn("rounded-xl border p-3 overflow-hidden", color)}>
            ...
            <div className="flex items-end gap-1">
                ...
                <span className="text-[9px] text-muted-foreground mb-0.5">reussite</span>
            </div>
            ...
            <div className={cn("text-[10px] font-bold mt-1", (data.roi_singles_pct ?? data.roi_pct ?? 0) >= 0 ? "text-emerald-400" : "text-red-400")}>
